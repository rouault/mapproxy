...
def UnsupportedException(Exception):
    pass
...
def tile_grid_from_ogc_tile_matrix_set(ogc_tile_matrix_set):
    ...
    for tileMatrix in tileMatrices:
        ...
        if tileWidth is None:
            ...
            if cornerOfOrigin == "topLeft":
                ...
                raise ValueError(f"Invalid cornerOfOrigin={cornerOfOrigin}")
        else:
    ...
    return TileGrid(srs=srs, bbox=bbox, tile_size=(tileWidth, tileHeight),
